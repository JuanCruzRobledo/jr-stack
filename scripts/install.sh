...
# ============================================================================
# jr-stack — Install Script
# One command to configure any AI coding agent on any OS.
#
# Usage:
#   curl -sL https://raw.githubusercontent.com/Gentleman-Programming/jr-stack/main/scripts/install.sh | bash
#
# Or download and run:
#   curl -sLO https://raw.githubusercontent.com/Gentleman-Programming/jr-stack/main/scripts/install.sh
#   chmod +x install.sh
#   ./install.sh
# ============================================================================
...
# Examples:
#   jr-stack_1.0.0_darwin_arm64.tar.gz
#   jr-stack_1.0.0_linux_amd64.tar.gz
# ============================================================================
