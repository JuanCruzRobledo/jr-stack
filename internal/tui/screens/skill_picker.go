...
// openSpecSkillIDs are the OPSX orchestrator skills shown in the first group.
var openSpecSkillIDs = []model.SkillID{
...
var skillLabels = map[model.SkillID]string{
	model.SkillOpenSpecInit:    "OPSX Init",
	model.SkillOpenSpecExplore: "OPSX Explore",
	model.SkillOpenSpecPropose: "OPSX Propose",
	model.SkillOpenSpecSpec:    "OPSX Spec",
	model.SkillOpenSpecDesign:  "OPSX Design",
	model.SkillOpenSpecTasks:   "OPSX Tasks",
	model.SkillOpenSpecApply:   "OPSX Apply",
	model.SkillOpenSpecVerify:  "OPSX Verify",
	model.SkillOpenSpecArchive: "OPSX Archive",
	model.SkillOpenSpecOnboard: "OPSX Onboard",
...
// AllSkillsOrdered returns all skills in display order: OPSX group first, then Foundation.
...
func RenderSkillPicker(selectedSkills []model.SkillID, cursor int) string {
	...
	// ── OPSX Skills group ──────────────────────────────────────────────────────
	b.WriteString(styles.HeadingStyle.Render("OPSX Skills"))
	b.WriteString("\n")

	for idx, skillID := range openSpecSkillIDs {
