...
import (
	...
	"github.com/juancruzrobledo/jr-stack/internal/components/gga"
	"github.com/juancruzrobledo/jr-stack/internal/components/mcp"
	"github.com/juancruzrobledo/jr-stack/internal/components/permissions"
...
var (
	...
	// AppVersion is the jr-stack version that will be written into backup manifests.
	// It is set by app.go before any CLI operation so that every backup created during
	// an install or sync records which version of jr-stack made it.
...
type prepareBackupStep struct {
	...
	// appVersion is the jr-stack version that created this backup.
