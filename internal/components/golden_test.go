...
import (
	...
	"github.com/juancruzrobledo/jr-stack/internal/agents/antigravity"
	"github.com/juancruzrobledo/jr-stack/internal/agents/claude"
	codexagent "github.com/juancruzrobledo/jr-stack/internal/agents/codex"
	"github.com/juancruzrobledo/jr-stack/internal/agents/cursor"
	"github.com/juancruzrobledo/jr-stack/internal/agents/gemini"
	"github.com/juancruzrobledo/jr-stack/internal/agents/opencode"
	"github.com/juancruzrobledo/jr-stack/internal/agents/vscode"
	"github.com/juancruzrobledo/jr-stack/internal/agents/windsurf"
	"github.com/juancruzrobledo/jr-stack/internal/assets"
	"github.com/juancruzrobledo/jr-stack/internal/components/engram"
	"github.com/juancruzrobledo/jr-stack/internal/components/mcp"
	"github.com/juancruzrobledo/jr-stack/internal/components/persona"
	"github.com/juancruzrobledo/jr-stack/internal/components/sdd"
	"github.com/juancruzrobledo/jr-stack/internal/components/skills"
...
func TestGoldenConfigs(t *testing.T) {
	...
	presets := []presetMapping{
		...
		{Preset: "lite", Skills: toStringSlice(skills.SkillsForPreset("lite"))},
...
func TestGoldenSDD_Cursor(t *testing.T) {
	...
	// Cursor writes SDD orchestrator to ~/.cursor/rules/jr-stack.mdc.
	rulesFile := readTestFile(t, filepath.Join(home, ".cursor", "rules", "jr-stack.mdc"))
...
func TestGoldenSDD_Windsurf(t *testing.T) {
	...
	assertGolden(t, "sdd-windsurf-workflow-opsx-propose.golden", workflowContent)
}
...
func TestGoldenCombined_Windsurf(t *testing.T) {
	...
	workflowMD := readTestFile(t, filepath.Join(workspace, ".windsurf", "workflows", "opsx-propose.md"))
	assertGolden(t, "sdd-windsurf-workflow-opsx-propose.golden", workflowMD)
}
